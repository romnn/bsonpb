...
var marshalingTests = []struct {
	...
	{"enum-value pretty object", Marshaler{EnumsAsInts: true, OmitDefaults: true},
		&pb.Widget{Color: pb.Widget_BLUE.Enum()},
		bson.D{{"color", pb.Widget_Color(2)}},
	},
	{"unknown enum value object", Marshaler{OmitDefaults: true},
		&pb.Widget{
	...
	{"repeated proto3 enum as int", Marshaler{EnumsAsInts: true, OmitDefaults: true},
		&proto3pb.Message{RFunny: []proto3pb.Message_Humour{
			proto3pb.Message_PUNS,
			proto3pb.Message_SLAPSTICK,
		}},
	...
	{"empty value", Marshaler{OmitDefaults: true}, &pb.Simple3{}, bson.D{}},
	...
	{"Duration with nanos", Marshaler{OmitDefaults: true},
	...
	{"Duration with large secs", Marshaler{OmitDefaults: true},
		&pb.KnownTypes{Dur: &durpb.Duration{Seconds: 1e8, Nanos: 1}},
		bson.D{{"dur", float64(1e+8)}},
	},
	{"Duration with 6-digit nanos", Marshaler{OmitDefaults: true},
		&pb.KnownTypes{Dur: &durpb.Duration{Nanos: 1e4}},
		bson.D{{"dur", float64(1e-05)}},
	},
	{"Duration with 3-digit nanos", Marshaler{OmitDefaults: true},
		&pb.KnownTypes{Dur: &durpb.Duration{Nanos: 1e6}},
		bson.D{{"dur", float64(0.001)}},
	},
	{"Duration with -secs -nanos", Marshaler{OmitDefaults: true},
		&pb.KnownTypes{Dur: &durpb.Duration{Seconds: -123, Nanos: -450}},
		bson.D{{"dur", float64(-123.00000045)}},
	},
	{"Duration max value", Marshaler{OmitDefaults: true},
		&pb.KnownTypes{Dur: &durpb.Duration{Seconds: 3155760000, Nanos: 999999999}},
		bson.D{{"dur", float64(3.155760001e+09)}},
	},
	{"Duration min value", Marshaler{OmitDefaults: true},
		&pb.KnownTypes{Dur: &durpb.Duration{Seconds: -3155760000, Nanos: -999999999}},
		bson.D{{"dur", float64(-3.155760001e+09)}},
	},
	{"Struct", Marshaler{OmitDefaults: true},
	...
	{"empty ListValue", Marshaler{OmitDefaults: true},
		&pb.KnownTypes{Lv: &stpb.ListValue{}},
		bson.D{{"lv", bson.A{}}},
	},
	{"basic ListValue", Marshaler{OmitDefaults: true},
	...
	{"Timestamp", Marshaler{OmitDefaults: true},
...
func TestMarshalUnsetRequiredFields(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			marshaler: &Marshaler{OmitDefaults: true},
			pb:        &pb.MsgWithRequired{},
		},
		{
